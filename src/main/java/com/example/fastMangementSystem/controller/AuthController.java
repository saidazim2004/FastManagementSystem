...
public class AuthController {
    ...
    public ResponseEntity<UserEntity> adminSignUp(
            @Valid @RequestBody UserCreateDto userDto ,BindingResult bindingResult
    ) {
        if (!bindingResult.hasErrors()) {
            List<ObjectError> allErrors = bindingResult.getAllErrors();
            throw new RequestValidationException(allErrors);
    ...
    public ResponseEntity<UserEntity> userSignUp(@Valid @RequestBody UserCreateDto userDto, BindingResult bindingResult) {
    ...
    public ResponseEntity<UserEntity> mentorSignUp(@Valid @RequestBody UserCreateDto userDto, BindingResult bindingResult) {
    ...
    public ResponseEntity<UserEntity> operatorSignUp(@Valid @RequestBody UserCreateDto userDto, BindingResult bindingResult) {
        if (!bindingResult.hasErrors()) {
            List<ObjectError> allErrors = bindingResult.getAllErrors();
            throw new RequestValidationException(allErrors);
        }
    ...
    public ResponseEntity<UserEntity> studentAdd(@Valid @RequestBody UserCreateDto userDto, BindingResult bindingResult) {
        if (!bindingResult.hasErrors()) {
            List<ObjectError> allErrors = bindingResult.getAllErrors();
            throw new RequestValidationException(allErrors);
        }
